...
export interface ApiBlogCategoryBlogCategory
  ...
  info: {
    description: '\uBE14\uB85C\uADF8 \uCE74\uD14C\uACE0\uB9AC | name:\uCE74\uD14C\uACE0\uB9AC\uBA85, slug:\uC2AC\uB7EC\uADF8, description:\uC124\uBA85, color:\uC0C9\uC0C1, icon:\uC544\uC774\uCF58, order:\uC815\uB82C \uC21C\uC11C';
    displayName: '30. BlogCategory(\uBE14\uB85C\uADF8\uCE74\uD14C\uACE0\uB9AC)';
...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\uBE14\uB85C\uADF8 \uD3EC\uC2A4\uD2B8 | title:\uC81C\uBAA9, slug:\uC2AC\uB7EC\uADF8, content:\uBCF8\uBB38, excerpt:\uC694\uC57D, featuredImage:\uB300\uD45C \uC774\uBBF8\uC9C0, publishedAt:\uBC1C\uD589\uC77C, updatedAt:\uC218\uC815\uC77C, status:\uC0C1\uD0DC, category:\uCE74\uD14C\uACE0\uB9AC, tags:\uD0DC\uADF8, readingTime:\uC608\uC0C1 \uC77D\uAE30 \uC2DC\uAC04(\uBD84), views:\uC870\uD68C\uC218, featured:\uCD94\uCC9C\uAE00 \uC5EC\uBD80, seoTitle:SEO \uC81C\uBAA9, seoDescription:SEO \uC124\uBA85, tableOfContents:\uBAA9\uCC28, relatedPosts:\uAD00\uB828 \uAE00, order:\uC815\uB82C \uC21C\uC11C';
    displayName: '31. BlogPost(\uBE14\uB85C\uADF8\uAE00)';
...
export interface ApiCareerDetailCareerDetail
  ...
  info: {
    description: '\uACBD\uB825 \uAE30\uC220\uC11C';
    displayName: '23. CareerDetail(\uACBD\uB825\uAE30\uC220\uC11C)';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    lessonsLearned: Schema.Attribute.RichText;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    solutions: Schema.Attribute.RichText;
...
export interface ApiCompanyCompany extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\uD68C\uC0AC/\uACBD\uB825 \uC815\uBCF4';
    displayName: '20. Company(\uACBD\uB825)';
...
export interface ApiOtherExperienceOtherExperience
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<['Class', 'ETC']> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::other-experience.other-experience'
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProfileProfile extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    location: Schema.Attribute.String;
    mainBio: Schema.Attribute.RichText;
    name: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    endDate: Schema.Attribute.String;
    featured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    featuredOrder: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    adminPassword: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 50;
        minLength: 6;
      }>;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    enableVisitorTracking: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
    ...
    > &
      Schema.Attribute.Private;
    maxVisitorsPerDay: Schema.Attribute.Integer &
    ...
    siteUsed: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiSkillSkill extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['Frontend', 'Backend', 'Database', 'Tools', 'Server', 'Other']
    > &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::other-experience.other-experience': ApiOtherExperienceOtherExperience;
