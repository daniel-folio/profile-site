...
const VantaBackground = dynamic(() => import('@/features/public/components/v2/layout/VantaBackground'), {
  ssr: false,
});
  ...
  if (!profile) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4 py-8">
        <div className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-md border border-white/40 dark:border-gray-700/50 p-10 md:p-14 rounded-3xl shadow-xl shadow-gray-200/50 dark:shadow-black/20 max-w-xl w-full">
          <svg width="72" height="72" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="mx-auto text-blue-500/40 dark:text-blue-400/40 mb-6">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
          </svg>
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-800 dark:text-gray-100 tracking-tight">프로필 등록 대기 중</h2>
          <p className="text-gray-500 dark:text-gray-400 mb-8 leading-relaxed max-w-sm mx-auto">
            아직 포트폴리오 프로필이 작성되지 않았습니다.<br />관리자 페이지에서 나만의 멋진 소개를 작성해 보세요.
          </p>
          <div className="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-blue-500/10 to-purple-500/10 dark:from-blue-500/20 dark:to-purple-500/20 border border-blue-500/20 dark:border-blue-400/20 rounded-full text-blue-600 dark:text-blue-400 font-medium text-sm shadow-sm transition-all hover:shadow-md">
