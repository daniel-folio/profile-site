...
import CareerDetailPdfDownloadButton from '@/features/public/components/CareerDetailPdfDownloadButton';

export default function CareerDetailClientV2({ companies, projects, careerDetails, profile }: {
  companies: Company[];
  projects: Project[];
