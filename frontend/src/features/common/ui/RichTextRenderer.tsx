...
export function RichTextRenderer({ text, className }: RichTextRendererProps) {
  ...
  let mergedClassName = (className ?? '').split(/\s+/).includes('prose') ? (className ?? '') : `prose dark:prose-invert max-w-none prose-p:my-3 prose-li:my-1 prose-blockquote:my-4 prose-h1:mb-6 prose-h2:mt-10 prose-h2:mb-4 prose-h3:mt-8 prose-h3:mb-3 prose-h4:mt-6 prose-h4:mb-2 prose-pre:bg-gray-900 prose-pre:text-white dark:prose-pre:!bg-[#23272e] dark:prose-pre:!text-white ${className ?? ''}`;
